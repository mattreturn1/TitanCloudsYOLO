...
def run_inference_and_metrics():
    model = YOLO("runs/cloud_yolo_seg/weights/best.pt")

    test_images_dir = "../datasets/Dataset/test/images"
    label_dir = "../datasets/Dataset/test/labels"
